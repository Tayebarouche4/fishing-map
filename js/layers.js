...
function toggleCurrent1(btn)  { toggleCurrentsPanel(); }
function toggleCurrent50(btn) { toggleCurrentsPanel(); }

function toggleCurrentsPanel() {
  ...
  if (currentsPanelOpen) { closeCurrentsPanel(); return; }
  openCurrentsPanel();
}
