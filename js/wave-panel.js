(function(){
  ...
  function renderWave(payload){
    ...
    body.innerHTML = stripHtml
      + '<div class="wave-chart-scroll"><div class="wave-chart-box" id="wave-chart-box"><canvas id="wave-canvas"></canvas></div></div>'
  ...
  function drawWaveChart(times, values, calmMax, moderateMax){
    ...
    // عرض حقيقي أكبر من الشاشة حسب عدد النقاط، مع لفافة تمرير أفقي (wave-chart-scroll)
    var PX_PER_HOUR = 10;
    var chartBox = document.getElementById('wave-chart-box');
