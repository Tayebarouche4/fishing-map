...
var VALID_CODES    = []; // غير مستخدمة — التحقق عبر السيرفر
...
function sendCorrection() {
  ...
  var payload = {
    ...
    obstacleType: optionText, rating: optionText,
    note: extra ? (optionText + ' — ' + extra) : optionText,
    reportType: 'correction', category: optionText,
    categoryText: optionText, optionText: optionText,
    hazardLabel: optionText,
    sheetRow: [now.toLocaleDateString('fr-DZ'), now.toLocaleTimeString('fr-DZ'),
               currentUser, String(gpsLat.toFixed(6)), String(gpsLon.toFixed(6)),
               optionText, extra],
  };
