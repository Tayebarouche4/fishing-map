...
يدمج نموذجين:
- ARPEGE Europe (Météo-France): 11 كم، يغطي أوروبا وشمال أفريقيا (يشمل الجزائر)،
  يُستعمل لأول 48 ساعة (يومين) كمصدر أدق من الموسّع.
...
MODEL_LOCAL_HD   = "meteofrance_arpege_europe"  # 11 كم، يغطي أوروبا وشمال أفريقيا (يشمل الجزائر)، حتى 4 أيام
MODEL_LOCAL_DAYS = 2
...
def fetch_wind_blended():
    ...
    try:
        # نتوقع نجاح هذا النموذج الآن (يغطي شمال أفريقيا فعلياً)، فنعطيه فرصة إعادة محاولة كاملة
